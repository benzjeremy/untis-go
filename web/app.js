...
(function () {
  ...
  const APP_RELEASES = [
      ...
      sections: [
        {
          ...
          items: [
            { type: 'security', text: '<strong>Entfernung des Gatekeepers & OneDrive-Modals:</strong> Alle ungenutzten Modale, Device-Code-Elemente und Microsoft-Buttons wurden restlos aus dem HTML gelöscht.' },
            { type: 'security', text: '<strong>JavaScript- und CSS-Bereinigung:</strong> Über 400 Zeilen ungenutzter Microsoft- und OneDrive-Code in app.js und style.css wurden restlos eliminiert.' },
            { type: 'feat', text: '<strong>Schnellerer App-Start:</strong> Keine unnötigen Status-Prüfungen oder Gatekeeper-Routinen beim Starten der Anwendung.' }
          ]
        }
      ]
    },
    {
      version: 'v2.3',
      title: 'Release v2.3 – iCalendar Export & Background Sync',
      type: 'feature',
      date: '10.09.2026',
      badge: 'Release v2.3',
      description: 'Automatischer iCal-Export (.ics), Hintergrund-Synchronisation und System-Tray-Integration.',
      sections: [
        {
          title: '📅 Kalender & System-Integration',
          items: [
            { type: 'feat', text: '<strong>iCalendar Export (.ics):</strong> Exportiere deinen Stundenplan direkt in Thunderbird, Outlook oder Apple Kalender.' },
            { type: 'feat', text: '<strong>Hintergrund-Synchronisation:</strong> Regelmäßige Aktualisierung der Stundenpläne im Hintergrund.' }
          ]
        }
      ]
    },
    {
      version: 'v2.2',
      title: 'Release v2.2 – Datenschutz-Compliance & Microsoft-Login-Entfernung',
      type: 'security',
      date: '10.09.2026',
      badge: 'Release v2.2',
      description: 'Datenschutz-Compliance (DSGVO / LDI NRW): Vollständige Entfernung des Microsoft-OAuth2-Logins und OneDrive-Syncs aus dem Backend und Core-System.',
      sections: [
        {
          title: '🔒 Datenschutz & Privatsphäre',
          items: [
            { type: 'security', text: '<strong>Vollständige Backend-Entfernung:</strong> Löschung aller cloud/* Pakete und Microsoft-API-Routen.' },
            { type: 'security', text: '<strong>Offizielle Entschuldigung & Transparenz:</strong> Rückkehr zum Kernprinzip 100% Local-First & Zero Telemetrie.' }
          ]
        }
      ]
    },
      ...
      sections: [
        {
          ...
          items: [
            { type: 'feat', text: '<strong>Keine Browser-Popups mehr:</strong> Alle Lösch- und Abmeldeaktionen (Profile, Hausaufgaben, Abwesenheiten) nutzen nun einen eigens gestalteten, voll integrierten Bestätigungsdialog.' },
